package com.epam.Logging_Code_House;
import org.apache.logging.log4j.*;
import java.util.Scanner;
class House_Construction
{
	private static Logger myLogger=LogManager.getLogger(House_Construction_Cost.class);
	...
	public void get_house_information()
	{
		...
		myLogger.info(total_area_house);
